...
def bring_all_models(cat_name="", feat_space=[]):
...
def make_all_clusters(cat_name="", feat_space=[], data=None, max_clusters=10):
    clusters = dict()
    for i in range(1, max_clusters + 1):
        clusters[str(i)] = make_clusters(cat_name, feat_space, i, data)
