...
def scatter2DWithClusters(model_name, data, title="", xlabel="", ylabel=""):
    ...
    ax.scatter(data.iloc[:, 0], data.iloc[:, 1], c=labels, s=6)
    draw_cluster_boundary(ax, model, )
    plt.show()
